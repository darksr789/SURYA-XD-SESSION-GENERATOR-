...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            ...
            password: 'VZ:xi2q3-F8A43j' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'SURYA-XD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of SURYA-XD.
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [DARK SURYA GitHub Repo](https://github.com/darksr789/)  
